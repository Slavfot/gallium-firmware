...
int main()
{
    ...
    nrf_gzll_set_timeslots_per_channel_when_device_out_of_sync(12);
    // nrf_gzll_set_datarate(NRF_GZLL_DATARATE_1MBIT);
    nrf_gzll_set_timeslot_period(1200);
    
    //calculation for timeslot_period: channel_table_size*timeslots_per_channel

    // Addressing
    nrf_gzll_set_base_address_0(0x010A030B);
    nrf_gzll_set_base_address_1(0x050C070D);
